...
gui.add(material, 'iridescenceIOR').min(1).max(2.333).step(0.0001) // min 1 en max 2.333 is belangrijk, omdat als je verder gaat je geen materials krijgt irl
...
gui.add(material, 'thickness').min(0).max(1).step(0.0001) // thickness van object, is niet bij three.js gedaan je moet een predifined thickness hebben
